        ...
        <div className="bg-[#FFFFFF] text-[#1D1D1F]">
            ...
            <section className="py-[150px] pb-[60px] bg-gradient-to-br from-[#F5F5F7] to-[#FFFFFF] text-center">
                <div className="bkb-container">
                    ...
                    <p className="text-[21px] text-[#86868B] mb-12">{t('subtitle')}</p>
            ...
            <section className="py-[80px]">
                <div className="bkb-container max-w-[1200px]">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
                        {manufacturers.map((m, index) => (
                            <div key={index} className="aspect-square bg-[#F5F5F7] rounded-[20px] flex flex-col items-center justify-center cursor-pointer hover:bg-[#E5E5E7] transition-colors">
                                <div className="text-[40px] font-bold text-[#D2D2D7] mb-2">{m.logo}</div>
                    ...
                    {/* Featured Models */}
                    <div className="mb-20">
                        <h2 className="text-[32px] font-bold mb-8 text-[#1D1D1F]">{t('featured.title')}</h2>
