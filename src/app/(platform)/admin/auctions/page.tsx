    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Auction Control Center</h1>
                    <p className="text-sm text-gray-500">Monitor live bids and manage auction schedules.</p>
                </div>
            ...
            <div className="grid grid-cols-4 gap-4">
                <Card className="bg-blue-600 text-white border-none">
                    <CardContent className="p-4">
                        <p className="text-xs opacity-80 font-bold uppercase">Active Auctions</p>
                        <p className="text-3xl font-black">{liveAuctions.length}</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardContent className="p-4">
                        <p className="text-xs text-gray-500 font-bold uppercase">Today's Volume</p>
                        <p className="text-3xl font-black text-gray-900">¥7.1M</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardContent className="p-4">
                        <p className="text-xs text-gray-500 font-bold uppercase">Total Bids (24h)</p>
            ...
            <div className="space-y-4">
                                ...
                                <CardContent className="p-0 flex flex-col md:flex-row">
                                    ...
                                    <div className="p-6 flex-1 flex gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-4 text-sm">
                                                <span className="text-gray-600">Top Bidder: <span className="font-bold text-[#0F4C81]">{auction.bidder}</span></span>
                                    ...
                                    <div className="p-6 bg-gray-50 md:w-64 flex flex-col justify-center border-t md:border-t-0 md:border-l border-gray-100">
                                        <div className="flex justify-between items-center mb-1">
                                            ...
                                            <span className="text-xs font-bold text-red-600 animate-pulse">{auction.time} left</span>
                                        </div>
                                        <p className="text-2xl font-black text-[#0F4C81] mb-3">¥{auction.price.toLocaleString()}</p>

                                        <div className="flex gap-2">
                                            <Button size="sm" variant="secondary" className="flex-1">Pause</Button>
                                            <Button size="sm" variant="danger" className="flex-1">End Now</Button>
                                        </div>
                                    </div>
                                </CardContent>
                            </Card>
                ...
                {activeTab === 'ended' && (
                    <div className="text-center py-12 text-gray-500">
                        Ended auctions history would appear here.
                    </div>
                )}
            </div>
        </div>
